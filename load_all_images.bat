...
IF /I "%DO_ALL_IMAGES%" EQU "1" (
    ...
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/InsertMouthpiece_Text_Small.bmp "Insert MCA Text" 2000 1700 88 88
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/Reading_Text.bmp "Reading Text" 2001 1780 76 92
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/Display_SerialNumber_Text_Small.bmp "Show SN" 2002 1856 84 58
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/PressToStartTherapy_Text_Small.bmp "Press Start" 2003 2026 84 58
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/MCA_ReadingError_Text.bmp "Read Error" 2004 2194 96 68
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/MuReva_Logo_Rev2.bmp "Mureva logo" 1000 2300 0 0
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/Red_Text_Box_Small.bmp "Red Box" 2005 2902 70 49
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/MouthpieceExpired_Text.bmp "MCA Expired" 2006 3128 76 92   
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/MouthpieceDetached_Text.bmp "MCA Unplugged" 2007 3204 96 68
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/Paused_Text.bmp "Paused" 2008 3310 126 72
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/Blank_60x16.bmp "Blank 60x16" 2009 3316 125 70
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/TherapyComplete_Text.bmp "Therapy Complete" 2010 3326 104 88
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/MouthpieceDailyLimit_Text.bmp "Daily Limit" 2011 3376 76 78
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/PressToResumeTherapy_Text_Small.bmp "Resume Therapy" 2012 3490 84 58
    REM   --------------------------------------------------------------------------------------------------Clock images
...
IF /I "%DO_ALL_IMAGES%" EQU "1" (
    ...
    REM %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/White_Text_Box.bmp "White Text Box" 2700 5910 66 46
    %PYTHON_PATH% Load_Bitmap.py %PORT% %SPEED% %IMAGE_PATH%/White_Text_Box_Small.bmp "White Text Box" 2700 5910 70 49
